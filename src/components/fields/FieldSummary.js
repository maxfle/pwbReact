        ...
        <table className="highlight responsive black-text z-depth-4 field-summary">
            <tbody>
                <tr>
                    ...
                    <td><a target="_blank" rel="noopener noreferrer" href={`https://www.google.com/maps/search/?api=1&query=${field.address.split(' ').join('+').replace("&","and")}`} class="secondary-content red black-text btn"> <span className="valign-wrapper">map<i class=" small material-icons">directions</i></span></a></td>
                </tr>
            </tbody>
        </table>
        // <div>
